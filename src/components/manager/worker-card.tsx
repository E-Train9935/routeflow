...
export function WorkerCard({
  ...
  return (
    <article className="min-w-0 overflow-hidden rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
      ...
      {worker.activeTrip ? (
        <>
            ...
            <div className="mt-5 rounded-xl bg-blue-50 p-4">
              ...
              <p className="mt-1 text-sm text-blue-700">
                ...
                {worker
                  .queuedTrips
                  .length > 0
                  ? ` ${worker.queuedTrips.length} more ${worker.queuedTrips.length === 1 ? "trip" : "trips"} queued.`
                  : ""}
              </p>
            </div>
          )}
          ...
          <div className="mt-5 grid grid-cols-1 gap-2 sm:grid-cols-2">
            <button
              type="button"
              className="flex min-w-0 items-center justify-between rounded-xl border border-zinc-200 px-4 py-3 text-sm font-medium transition hover:bg-zinc-50"
            >
              View trip
            ...
            <button
              ...
              className="flex min-w-0 items-center justify-center gap-2 rounded-xl bg-zinc-950 px-4 py-3 text-sm font-medium text-white transition hover:bg-zinc-800 disabled:opacity-50"
            >
            ...
            <div className="mt-3 max-w-full overflow-hidden rounded-xl border border-zinc-200 bg-zinc-50 p-3">
              ...
              <div className="mt-2 grid min-w-0 max-w-full grid-cols-[minmax(0,1fr)_auto] gap-2">
                ...
                <button
                  ...
                  className="flex h-9 shrink-0 items-center justify-center gap-1.5 rounded-lg bg-zinc-950 px-3 text-xs font-medium text-white"
                >
                  {copied ? (
                    <>
